...
export const scanCommandTool = {
  name: 'scan_command',
  description: `Protective check on shell commands — catches injection or unsafe operations before execution, so you don't run something you would not have run if you'd known.
